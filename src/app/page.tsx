...
const HOME_COPY: Record<Language, HomeCopy> = {
  en: {
    ...
    trust: [
      ...
      { title: "We never move your money", body: "You complete the transfer on the provider’s own app/site." },
      { title: "Independent", body: "Clear comparison (with affiliate links when available)." },
    ],
    cardTitle: "Money without borders",
    cardSubtitle: "Compare • choose • send with confidence",
    miniSteps: [
      { title: "Enter the amount in USD", body: "You tell us how much you want to send." },
      { title: "See total cost and BRL estimate", body: "Fees + FX (spread) + speed." },
      { title: "Click through and finish with the provider", body: "The transfer happens outside Kaishio." },
    ],
  ...
  pt: {
    ...
    trust: [
      { title: "Sem pegadinhas", body: "Mostramos estimativas e explicamos o spread do câmbio." },
      { title: "Sem mover o seu dinheiro", body: "Você finaliza no próprio app/site do provedor." },
      { title: "Independente", body: "Comparação clara (com links afiliados quando houver)." },
    ],
    ...
    miniSteps: [
      ...
      { title: "Veja custo total e BRL estimado", body: "Taxas + câmbio (spread) + velocidade." },
      { title: "Clique e finalize no provedor", body: "A transferência acontece fora do Kaishio." },
    ],
  ...
  es: {
    ...
    trust: [
      { title: "Sin trucos", body: "Mostramos estimaciones y explicamos el spread del tipo de cambio." },
      { title: "Nunca tocamos tu dinero", body: "Finalizas en la propia app/sitio del proveedor." },
      { title: "Independiente", body: "Comparación clara (con enlaces de afiliado cuando existan)." },
    ],
    ...
    miniSteps: [
      ...
      { title: "Ve el costo total y el BRL estimado", body: "Comisiones + tipo de cambio (spread) + velocidad." },
      { title: "Haz clic y termina con el proveedor", body: "La transferencia ocurre fuera de Kaishio." },
    ],
        ...
        <div className="grid gap-10 lg:grid-cols-2 lg:items-center">
          <div>
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-3">
              <Link href="/compare" className="inline-flex justify-center rounded-xl bg-white text-black px-5 py-3 font-semibold hover:bg-white/90 transition">
                {t.primaryCta}
              </Link>

              <Link href="/how-it-works" className="inline-flex justify-center rounded-xl border border-white/15 bg-white/5 px-5 py-3 font-semibold text-white hover:bg-white/10 transition">
                {t.secondaryCta}
              </Link>
            </div>
            ...
            <div className="rounded-3xl border border-white/15 bg-white/5 p-7 backdrop-blur">
              ...
              <div className="mt-6 grid gap-3">
                {t.miniSteps.map((step, idx) => (
                  <MiniStep key={idx} n={(idx + 1).toString()} title={step.title} body={step.body} />
                ))}
              </div>
              ...
              <div className="mt-6 rounded-2xl border border-white/15 bg-black/30 p-4">
                ...
                <div className="mt-2 text-sm text-white/70">{t.providersBody}</div>
              </div>

              <div className="mt-5 flex flex-col sm:flex-row gap-3">
                <Link href="/education" className="inline-flex justify-center rounded-xl border border-white/15 bg-white/5 px-5 py-3 font-semibold text-white hover:bg-white/10 transition">
                  {t.learnCta}
                </Link>
                <Link href="/compare" className="inline-flex justify-center rounded-xl bg-white text-black px-5 py-3 font-semibold hover:bg-white/90 transition">
                  {t.compareCta}
